...
@section('title', 'Impor Penjualan')
<div>
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Data Penjualan /</span> Impor Data
    </h4>

    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Form Impor Data Penjualan dari Excel</h5>
        </div>
        <div class="card-body">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <hr>
                <a href="{{ asset('templates/template_penjualan.xlsx') }}" class="btn btn-sm btn-primary" download>
