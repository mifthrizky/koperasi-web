...
new class extends Component
{
    ...
    public function import()
    {
        ...
        try {
            Excel::import(new BarangsImport, $this->file);

            session()->flash('success', 'Data barang berhasil diimpor!');
            $this->dispatch('import-success', url: route('barang.index'));
...
@section('title', 'Impor Barang')
<div>
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Data Barang /</span> Impor Data
    </h4>

    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Form Impor Data Barang dari Excel</h5>
        </div>
        <div class="card-body">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <p>Pastikan file Excel yang Anda unggah memiliki format yang benar dengan header: <strong>kode_item, nama_item, jenis, harga_satuan</strong>. Anda dapat mengunduh template yang sudah kami sediakan.</p>
                <hr>
                <a href="{{ asset('templates/template_barang.xlsx') }}" class="btn btn-sm btn-primary" download>
